    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content
                    className={`
                    md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] md:h-[60vh] md:rounded-md
                    fixed inset-0 overflow-hidden w-full bg-slate-700 flex flex-col outline-none`}
                >
